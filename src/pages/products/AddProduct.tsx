      ...
      <div className="bg-white rounded-2xl shadow-lg p-6 md:p-8">
        <form className="space-y-6">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div>
              <label className="block text-sm font-semibold mb-2">Sous-type</label>
              <input
                type="text"
                value={productForm.sous_type}
                onChange={(e) => setProductForm({ ...productForm, sous_type: e.target.value })}
                className="w-full px-4 py-3 border border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-green-500"
            ...
            <div>
              ...
              <input
                ...
                onChange={(e) => setProductForm({ ...productForm, quantite_disponible: e.target.value })}
                className="w-full px-4 py-3 border border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-green-500"
                placeholder="Ex: 500"
              />
            </div>
            ...
            <div>
              <label className="block text-sm font-semibold mb-2">Unité *</label>
              <select
                value={productForm.unite}
                onChange={(e) => setProductForm({ ...productForm, unite: e.target.value })}
                className="w-full px-4 py-3 border border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-green-500"
              >
            ...
            <div>
              <label className="block text-sm font-semibold mb-2">Prix Unitaire (Ar) *</label>
              <input
                type="number"
            ...
            <div>
              <label className="block text-sm font-semibold mb-2">Date de Récolte *</label>
              <input
                type="date"
                value={productForm.date_recolte}
                onChange={(e) => setProductForm({ ...productForm, date_recolte: e.target.value })}
                className="w-full px-4 py-3 border border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-green-500"
              />
            </div>
          </div>
          ...
          <div>
            <label className="block text-sm font-semibold mb-2">Image du Produit</label>
