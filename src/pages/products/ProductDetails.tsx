      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div className="p-6">
              <div className="flex justify-between items-start mb-4">
                <div>
                  ...
                  <div className="flex gap-2 flex-wrap">
                    <span className="bg-green-100 text-green-700 px-3 py-1 rounded-full text-sm font-semibold">
                      {product.statut === 'disponible' ? '✓ Disponible' : 'Rupture'}
                    </span>
                ...
                <div className="text-right">
                  <p className="text-4xl font-bold text-green-600">{product.prix_unitaire.toLocaleString()} Ar</p>
                ...
                <div className="grid grid-cols-2 gap-4 mt-6">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="font-bold">{product.quantite_disponible} {product.unite}</p>
                    </div>
                  </div>
                  <div className="flex items-center gap-3">
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="font-bold">{product.sous_type || 'Standard'}</p>
                    </div>
                  </div>
                </div>
              </div>
        ...
        <div className="space-y-6">
          <div className="bg-white rounded-2xl shadow-lg p-6">
            <h4 className="font-bold text-lg mb-4">Informations du Producteur</h4>
