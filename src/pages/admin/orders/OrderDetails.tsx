  ...
  const orders = [
    {
      ...
      statut: "en_attente",
      collecteur: "Société AgriTrade",
      paysan: "Jean Rakoto",
      prix_total: 250000,
      date_commande: "2025-11-03",
      date_livraison_prevue: "2025-11-10",
      adresse_livraison: "Antananarivo, Analamanga",
      mode_livraison: "livraison",
      message_collecteur: "Besoin urgent pour exportation",
    },
    {
      id: 2,
      produit: "Maïs Bio",
      ...
      statut: "acceptee",
      collecteur: "CoopéGrain",
      paysan: "Marie Rasoa",
      prix_total: 90000,
      date_commande: "2025-11-02",
      date_livraison_prevue: "2025-11-08",
      adresse_livraison: "Antsirabe, Vakinankaratra",
      mode_livraison: "sur_place",
    },
    {
      id: 3,
      produit: "Haricots Secs",
      quantite_commandee: 75,
      statut: "en_livraison",
      collecteur: "AgriTrade SA",
      paysan: "Paul Randria",
      prix_total: 240000,
      date_commande: "2025-11-01",
      date_livraison_prevue: "2025-11-06",
      adresse_livraison: "Antananarivo",
      mode_livraison: "livraison",
    },
  ];
      ...
      <div className="space-y-6">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                    ...
                    <div
                      className={`w-8 h-8 ${
                        order.statut !== "en_attente"
                          ? "bg-green-500"
                          : "bg-gray-300"
                      } rounded-full flex items-center justify-center text-white font-bold z-10`}
                    >
                  ...
                  <div className="grid grid-cols-2 gap-4 mt-3">
                    <div>
                      ...
                      <p className="font-semibold">
                        {order.quantite_commandee} kg
                      </p>
                    </div>
                    <div>
                      <p className="text-sm text-gray-500">Prix Total</p>
                      <p className="font-semibold text-green-600">
                        {order.prix_total.toLocaleString()} Ar
                      </p>
                    </div>
                  </div>
                </div>
              ...
              <div className="space-y-3">
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="font-semibold">
                      {order.mode_livraison === "livraison"
                        ? "🚚 Livraison à domicile"
                        : order.mode_livraison === "sur_place"
                        ? "🏪 Retrait sur place"
                        : "📋 À convenir"}
                    </p>
                  </div>
          ...
          <div className="space-y-6">
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <p className="font-bold">
                      {userRole === Role.PAYSAN ? order.collecteur : order.paysan}
                    </p>
                    <p className="text-sm text-gray-500">
                      {userRole === Role.PAYSAN ? "Entreprise" : "Producteur"}
                    </p>
                  </div>
                </div>
            ...
            {userRole === Role.PAYSAN && order.statut === "en_attente" && (
