...
const TopBar = ({ onMenuClick, isMobile }: TopBarProps) => {
  ...
  return (
    <div className="bg-white border-b px-4 md:px-8 py-1 flex justify-between md:justify-end items-center gap-4 shadow-sm fixed top-0 right-0 transition-all duration-300 md:left-64 left-0 z-99">
