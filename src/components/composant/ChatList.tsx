    ...
    <div className={`flex-1 overflow-y-auto`}>
      ...
      {chats.length === 0 ? (
        ...
        chats.map((conv) => {
          ...
          const time =
            conv.dernierMessage?.dateEnvoi ?? conv.dateDerniereActivite;
          const timeStr = time
          ...
          return (
            ...
            >
              <div className="relative shrink-0">
                <div className="w-12 md:w-14 h-12 md:h-14 rounded-full bg-linear-to-br from-green-100 to-green-200 flex items-center justify-center text-2xl shadow-sm overflow-hidden">
                  <img
              ...
              <div className="flex-1 min-w-0">
                <div className="flex justify-between items-baseline mb-1">
                  <h3 className="font-semibold text-gray-900 truncate flex items-center flex-nowrap gap-1">
                    {name}
                ...
                <div className="flex items-center justify-between gap-2">
                  ...
                  {conv.messagesNonLusP1 + conv.messagesNonLusP2 > 0 ? (
